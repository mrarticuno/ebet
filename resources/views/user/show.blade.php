    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-4 col-xs-12">
                <div class="white-box">
                    <div class="user-bg"> <img width="100%" alt="user" src="{{ $root.'/uploaded/'.$imagem->name_file }}">
                        <div class="overlay-box">
                            <div class="user-content"> <a href="javascript:void(0)"><img src="{{ $root.'/uploaded/'.$imagem->name_file }}" class="thumb-lg img-circle" alt="img"></a>
